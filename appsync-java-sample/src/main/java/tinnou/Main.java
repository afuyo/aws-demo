...
public class Main {
     ...
     */
    private static final String apiKey = "da2-q4fv4uhpxvgh5b2dope32ascou";
    ...
    public static void main(String[] args) {
       ...
       // String mutation = " mutation PutPost($id:ID !, $title: String!) {createPost(id: $id, title: $title) {id title } }";
        //String mutation = " mutation PutPost($id:ID !, $title: String!) {createPost(id: $id, title: $title) {id title } }";
        String mutation = " mutation PutPost {createPost(input:{title:\"HTTP HELLO\"}) {id title } }";
        //String mutation = " mutation PutPost($id:ID !, $title: String!,$author:String!,$version:Int!) {createPost(id: $id, title: $title,author:$title,version:5) {id title } }";
       // String mutation = " mutation PutPost{createPost(input:{id: $id, title: $title,author:$title,version:5}) {id title } }";
