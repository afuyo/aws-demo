...
public class DataRecordOrg extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public DataRecordOrg(Data data, Data beforeData, Headers headers) {
    this.data = data;
   ...
   * @return A new DataRecord RecordBuilder
   */
  public static Builder newBuilder(DataRecordOrg other) {
    return new Builder(other);
  }
   ...
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DataRecordOrg>
    implements org.apache.avro.data.RecordBuilder<DataRecordOrg> {
     ...
     * @param other The existing instance to copy.
     */
    private Builder(DataRecordOrg other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.data)) {
        this.data = data().deepCopy(fields()[0].schema(), other.data);
        fieldSetFlags()[0] = true;
    ...
    @Override
    public DataRecordOrg build() {
      try {
        DataRecordOrg record = new DataRecordOrg();
        if (dataBuilder != null) {
