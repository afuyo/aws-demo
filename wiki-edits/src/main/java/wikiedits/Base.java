...
public class Base {
 ...
 //   public static SourceFunction<TaxiRide> rides = null;
  //  public static SourceFunction<TaxiFare> fares = null;
    ...
    public final static String pathToRideData = "/home/statarm/githubrepos/flink-training-exercises/data/nycTaxiRides.gz";
    public final static String pathToFareData = "/home/statarm/githubrepos/flink-training-exercises/data/nycTaxiFares.gz";
