...
public class AvroKafkaFlinkTNKU077054Join {
    ...
    public static DataStream<Tuple3<String, Integer, String>> runWindowJoin(
            DataStream<person077.Data> grades,
        ...
        return grades.join(salaries)
                ...
                .apply(new JoinFunction<person077.Data, kommune.Data, Tuple3<String, Integer, String>>() {

                    @Override
                    public Tuple3<String, Integer, String> join(
                            person077.Data first,
                            kommune.Data second) {
    ...
    private static class NameKeySelector implements KeySelector<person077.Data,String>{
        @Override
