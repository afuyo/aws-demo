...
import join.WindowJoinSampleDataFK.GradeSource;
import join.WindowJoinSampleDataFK.SalarySource;
...
public class WindowJoinFK {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<Tuple2<Integer,String>> salaries = SalarySource.getSource(env, rate);
	...
	public static DataStream<Tuple3<String, Integer, Integer>> runWindowJoin(
			...
			DataStream<Tuple2<Integer,String>> salaries,
			long windowSize) {
		...
		return grades.join(salaries)
				...
				.apply(new JoinFunction<Tuple2<String, Integer>, Tuple2<Integer,String>, Tuple3<String, Integer, Integer>>() {

					@Override
					public Tuple3<String, Integer, Integer> join(
									Tuple2<String, Integer> first,
									Tuple2<Integer,String> second) {
						return new Tuple3<String, Integer, Integer>(first.f0, first.f1, second.f0);
					}
				});
	}
	...
	private static class NameKeySelector2 implements KeySelector<Tuple2<Integer,String>, String> {
		@Override
		public String getKey(Tuple2<Integer,String> value) {
			return value.f1;
		}
	}
