...
public class WindowJoinSampleDataFK {
	 ...
	 */
	public static class SalarySource implements Iterator<Tuple2<Integer,String>>, Serializable {
		...
		public Tuple2<Integer,String> next() {
			return new Tuple2<>(rnd.nextInt(SALARY_MAX) + 1,NAMES[rnd.nextInt(NAMES.length)] );
		}
		...
		public static DataStream<Tuple2<Integer,String>> getSource(StreamExecutionEnvironment env, long rate) {
